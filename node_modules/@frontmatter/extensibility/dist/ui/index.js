 ...
 * @param cb
 */
export const registerCustomField = (name, cb) => {
    window.fmExternal = window.fmExternal || {};
 ...
 * @since 8.5.0
 */
export const registerCardTitle = (cb) => {
    window.fmExternal = window.fmExternal || {};
 ...
 * @since 8.5.0
 */
export const registerCardDescription = (cb) => {
    window.fmExternal = window.fmExternal || {};
 ...
 * @since 8.5.0
 */
export const registerCardTags = (cb) => {
    window.fmExternal = window.fmExternal || {};
 ...
 * @since 8.5.0
 */
export const registerCardDate = (cb) => {
    window.fmExternal = window.fmExternal || {};
 ...
 * @since 8.5.0
 */
export const registerCardStatus = (cb) => {
    window.fmExternal = window.fmExternal || {};
